...
int main() {
    ...
    //XMLParser test;
    //string a="<element njyftrjyfh htrhyr>>>><elemente/>";
    //test.tokenizeInputString(a);
	...
	for (int i=0; i<tokenizedInput.size(); i++) {
		cout << "Type: " << myParser.struct2String(tokenizedInput[i]) << " string: "  << tokenizedInput[i].tokenString << endl;
	}
